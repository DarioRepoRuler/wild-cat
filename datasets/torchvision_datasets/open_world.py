...
class OWDetection(VisionDataset):
    ...
    def __init__(self,
        ...
        if args.split == 'owod':
            self.VOC_COCO_CLASS_NAMES = VOC_COCO_CLASS_NAMES_OLD #This will always be selected
        ...
        for year, image_set in zip(years, image_sets):
            ...
            if year == "2007" and image_set == "test":
                year = "2007-test"
            valid_sets = ["t1_train", "t2_train", "t3_train", "t4_train", "t2_ft", "t3_ft", "t4_ft", "test","test_custom",  "all_task_test"]
            if year == "2007-test":
            ...
            # voc root: /home/dario/Documents/CAT/data/OWDETR/VOC2007

            # extract_fns: will return filenames out of the test.txt file
    ...
    def load_instances(self, img_id):
        ...
        for obj in target['annotation']['object']:
            cls = obj["name"]
            #print(f"Classes read out of xml: {cls}")
            ...
            bbox[0] -= 1.0
            bbox[1] -= 1.0
            if cls in self.VOC_COCO_CLASS_NAMES:
                cat_id = self.VOC_COCO_CLASS_NAMES.index(cls)
            instance = dict(
                category_id=cat_id,
                bbox=bbox,
    ...
    def __getitem__(self, index):
        ...
        if self.transforms[-1] is not None:
            ...
            img, target_1 = self.transforms[-1](img, target)
        #print(f"Target here: \n{target}")
        return img, target
