...
def imagesets(coco_annotation_file, target_folder):
    ...
    with open("/home/dario/Documents/CAT/data/OWDETR/VOC2007/ImageSets/test.txt", "a") as myfile:
...
def coco_to_voc_detection(coco_annotation_file, target_folder):
    ...
    coco_instance = COCO(coco_annotation_file)
    print(f"Coco instance: {coco_instance.imgToAnns}")
...
if __name__ == '__main__':
    ...
    coco_annotation_file = '/home/dario/Documents/CAT/data/OWDETR/VOC2007/Annotations/instances_train2017.json'
    #target_folder = 'data/VOC2007'
    target_folder = '/home/dario/Documents/CAT/data/OWDETR/VOC2007'
