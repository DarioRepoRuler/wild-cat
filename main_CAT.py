...
def get_datasets(args):
    ...
    if args.dataset == 'owod':
        ...
        #dataset_val = OWDetection_custom(args, args.owod_path, ["2007"], image_sets=[args.test_set], transforms=make_coco_transforms(args.test_set))
    else:
...
def set_dataset_path(args):
    # /home/dario/Documents/CAT/data/OWDETR/VOC2007
    args.owod_path =os.path.join(os.getcwd(), os.path.join(args.data_root, 'VOC2007'))
