...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" python -u main_open_world.py \
    ...
    --resume 'exps/OWOD_t1_old_split/checkpoint0049.pth' \
    --eval \
    ${PY_ARGS}
...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" python -u main_open_world.py \
    ...
    --pseudo_store_path 'exps/loss_memory'  --adaptive_update_Iter 300 --memory_length 100 \
    --backbone 'dino_resnet50' \
    --resume 'exps/OWOD_t2_ft_old_split/checkpoint0100.pth' \
    --eval \
    ${PY_ARGS}
...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" python -u main_open_world.py \
    ...
    --pseudo_store_path 'exps/loss_memory'  --adaptive_update_Iter 300 --memory_length 100 \
    --backbone 'dino_resnet50' \
    --pretrain 'exps/OWOD_t3_ft_old_split/checkpoint0135.pth' \
    --eval \
    ${PY_ARGS}
...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" python -u main_open_world.py \
    ...
    --pseudo_store_path 'exps/loss_memory'  --adaptive_update_Iter 300 --memory_length 100\
    --backbone 'dino_resnet50' \
    --pretrain 'exps/OWOD_t4_ft_old_split/checkpoint0160.pth' \
    --eval \
    ${PY_ARGS}
