    ...
    def __init__(self, backbone_name: str, num_feature_levels: int, pretrained=None, use_checkpoint=False, dilation=False):
        if "swin" in backbone_name:
            ...
            if backbone_name == 'resnet50':
                ...
                print(f"OS path: {os.path.join(os.getcwd(),'models/dino_resnet50_pretrain.pth')}")
                state_dict = torch.load(os.path.join(os.getcwd(),'models/dino_resnet50_pretrain.pth'))
